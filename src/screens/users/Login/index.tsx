...
const Login = () => {
  ...
  return (
    <AuthWrapper>
      <section className="w-full lg:w-8/12 bg-white rounded-md text-zinc-900 h-full lg:h-fit flex flex-col justify-center items-center py-6">
        <form
        ...
        >
          ...
          <div className="flex justify-between">
            <Link to={BROWSER_ROUTE.FORGOT_PASSWORD}>
              {t("forgotPassword")}
            </Link>
          </div>
